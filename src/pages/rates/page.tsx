  ...
  return (
    <Layout>
      ...
      <div className={styles['rates']}>
        <h1 className={styles['rates__title']}>Отзывы</h1>
        <p className={styles['rates__subtitle']}>
          Оцените отзывы других покупателей о нашем интернет-магазине. <br />
          Получите достоверную информацию о качестве нашей продукции, <br />
          услуг помощи и консультаций. А также поделитесь впечатлениями <br />о работе с нами и
          оставьте свой отзыв после покупки
        </p>
